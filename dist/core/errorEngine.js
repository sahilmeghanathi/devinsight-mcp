...
function testRegex(pattern, text, flags = "i") {
...
const errorRules = [
    ...
    // ===============================================================
    {
        id: "undefined_map",
        priority: 1,
        match: (e) => testRegex("undefined.*\\.map|\\.map.*undefined|cannot read.*map.*of undefined", e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        insight: {
            type: "TypeError",
            cause: "Calling .map() on a non-array value (object, string, number, etc.)",
    ...
    },
    {
        id: "not_a_function",
        priority: 1,
        match: (e) => testRegex("is not a function", e) && !testRegex("map is not a function", e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => testRegex("(\\w+) is not defined", e) &&
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => testRegex("assignment to constant variable|cannot assign to .* because it is a constant", e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => testRegex("cannot assign to read only property|cannot set property .* which has only a getter", e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /\.forEach is not a function|forEach is not a function/.test(e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /\.includes is not a function|includes is not a function/.test(e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /\.flatMap is not a function|flatMap is not a function/.test(e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /\.unshift is not a function|unshift is not a function/.test(e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /\.indexOf is not a function|indexOf is not a function/.test(e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /\.reverse is not a function|reverse is not a function/.test(e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        id: "length_undefined",
        priority: 1,
        match: (e) => /cannot read propert(y|ies) ['"]?length['"]? of (undefined|null)/.test(e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /is not iterable|symbol\.iterator.*is not a function|cannot iterate/.test(e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /\.toLowerCase is not a function|toLowerCase is not a function/.test(e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /\.toUpperCase is not a function|toUpperCase is not a function/.test(e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /\.replace is not a function|replace is not a function/.test(e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /\.replaceAll is not a function|replaceAll is not a function/.test(e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /\.startsWith is not a function|startsWith is not a function/.test(e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /\.endsWith is not a function|endsWith is not a function/.test(e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /\.padStart is not a function|padStart is not a function/.test(e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /\.charCodeAt is not a function|charCodeAt is not a function/.test(e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /\.substring is not a function|substring is not a function/.test(e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        priority: 2,
        match: (e) => /\.normalize is not a function|normalize is not a function/.test(e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        priority: 2,
        match: (e) => /\.localeCompare is not a function|localeCompare is not a function/.test(e),
        insight: {
            type: "TypeError",
    ...
    // ===============================================================
    {
        ...
        priority: 1,
        match: (e) => /cannot convert (undefined|null) to object|object\.keys.*null|object\.keys.*undefined/.test(e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /cannot convert .* to object|object\.assign.*null|target is not an object/.test(e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /\.hasOwnProperty is not a function|hasOwnProperty is not a function/.test(e),
        insight: {
            type: "TypeError",
            cause: "Calling .hasOwnProperty() on null/undefined or object without prototype",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /\.toFixed is not a function|toFixed is not a function/.test(e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /\.toPrecision is not a function|toPrecision is not a function/.test(e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        priority: 2,
        match: (e) => /\.toExponential is not a function|toExponential is not a function/.test(e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        id: "precision_range",
        priority: 2,
        match: (e) => /toFixed.*digits argument|precision.*out of range|tofixed.*digits/.test(e),
        insight: {
            type: "RangeError",
    ...
    // ===============================================================
    {
        ...
        priority: 1,
        match: (e) => /(unexpected token|unexpected.*in json|json\.parse|json parse)/.test(e) &&
            /json|parse/.test(e),
        insight: {
            type: "SyntaxError",
    ...
    },
    {
        ...
        insight: {
            ...
            example: "JSON.stringify(obj, (k, v) => typeof v === 'bigint' ? v.toString() : v)",
            confidence: "high",
        },
    },
    {
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /\.(getTime|getDate|getMonth|getFullYear|getHours|getMinutes|getSeconds|toISOString|toDateString|toLocaleDateString) is not a function/.test(e),
        insight: {
            type: "TypeError",
    ...
    // ===============================================================
    {
        id: "invalid_regex",
        priority: 1,
        match: (e) => /invalid regular expression|unterminated group|invalid group|nothing to repeat/.test(e),
        insight: {
            type: "SyntaxError",
    ...
    },
    {
        ...
        priority: 2,
        match: (e) => /regular expression too large|regex.*stack overflow|catastrophic backtracking/.test(e),
        insight: {
            type: "RangeError",
    ...
    },
    {
        id: "await_non_async",
        priority: 1,
        match: (e) => /await is only valid in async function|unexpected.*await/.test(e),
        insight: {
            type: "SyntaxError",
    ...
    },
    {
        ...
        priority: 2,
        match: (e) => /\.finally is not a function|finally is not a function/.test(e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /promise\.all.*is not iterable|argument.*is not iterable/.test(e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        priority: 2,
        match: (e) => /async generator|asynciterator|for await.*of.*not async iterable/.test(e),
        insight: {
            type: "TypeError",
    ...
    // ===============================================================
    {
        id: "fetch_failed",
        priority: 1,
        match: (e) => /failed to fetch|fetch.*failed|networkerror when attempting to fetch/.test(e),
        insight: {
            type: "NetworkError",
    ...
    },
    {
        id: "cors_error",
        priority: 1,
        match: (e) => /cors|cross-origin|access-control-allow-origin|blocked by cors policy/.test(e),
        insight: {
            type: "CORSError",
    ...
    },
    {
        id: "abort_error",
        priority: 2,
        match: (e) => /abort|aborted|signal.*aborted|the operation was aborted/.test(e),
        insight: {
            type: "AbortError",
    ...
    },
    {
        ...
        insight: {
            type: "HTTPError",
            cause: "Request conflicts with current state (duplicate, version mismatch)",
    ...
    },
    {
        id: "ssl_error",
        priority: 1,
        match: (e) => /ssl|certificate|cert_|unable to verify|self.signed|expired certificate/.test(e),
        insight: {
            type: "SSLError",
    ...
    },
    {
        id: "duplicate_key",
        priority: 2,
        match: (e) => /encountered two children with the same key|duplicate key/.test(e),
        insight: {
            type: "ReactWarning",
    ...
    },
    {
        ...
        priority: 2,
        match: (e) => /can't perform a react state update on an unmounted component|update on unmounted/.test(e),
        insight: {
            type: "ReactWarning",
            cause: "State update attempted after component unmounted",
            fix: "Cancel async operations in useEffect cleanup",
            example: "useEffect(() => { let mounted = true; fetch().then(d => mounted && setState(d)); return () => { mounted = false; }; }, []);",
            confidence: "high",
        },
    },
    {
        ...
        priority: 2,
        match: (e) => /react hook .* has a missing dependency|missing dependency/.test(e),
        insight: {
            type: "ReactWarning",
            cause: "Variable used in useEffect/useMemo/useCallback not in dependency array",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /cannot update a component.*while rendering a different component|cannot update during.*render/.test(e),
        insight: {
            type: "ReactError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /rendered fewer hooks than expected|rendered more hooks/.test(e),
        insight: {
            type: "ReactError",
    ...
    },
    {
        ...
        priority: 2,
        match: (e) => /changing.*from uncontrolled to controlled|changing.*from controlled to uncontrolled/.test(e),
        insight: {
            type: "ReactWarning",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /element type is invalid|expected.*string.*or.*class|check the render method/.test(e),
        insight: {
            type: "ReactError",
    ...
    },
    {
        id: "jsx_runtime",
        priority: 1,
        match: (e) => /react\/jsx-runtime|jsx.*not defined|pragma.*cannot be set/.test(e),
        insight: {
            type: "BuildError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /cannot update a component from inside the function body/.test(e),
        insight: {
            type: "ReactError",
    ...
    },
    {
        ...
        priority: 2,
        match: (e) => /forwardref render functions.*proptype|forwardref.*do not support/.test(e),
        insight: {
            type: "ReactWarning",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /usecontext.*must be used within|context.*undefined|cannot read.*context/.test(e),
        insight: {
            type: "ReactError",
    ...
    },
    {
        id: "suspense_missing",
        priority: 1,
        match: (e) => /suspended while rendering.*wrap.*suspense|component suspended/.test(e),
        insight: {
            type: "ReactError",
    ...
    },
    {
        ...
        priority: 2,
        match: (e) => /string refs.*deprecated|using string refs is deprecated/.test(e),
        insight: {
            type: "ReactWarning",
    ...
    },
    {
        ...
        priority: 3,
        match: (e) => /strict mode.*side.effect|unsafe lifecycle|unsafe_componentwillmount/.test(e),
        insight: {
            type: "ReactWarning",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /localstorage is not defined|sessionstorage is not defined/.test(e),
        insight: {
            type: "SSRError",
            cause: "Accessing browser storage during server-side rendering",
            fix: "Access storage only in useEffect or client-side code",
            example: "useEffect(() => { const data = localStorage.getItem('key'); }, []);",
            confidence: "high",
        },
    },
    {
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /hydration failed|text content does not match|hydration mismatch/.test(e),
        insight: {
            type: "HydrationError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /router.*not mounted|userouter.*outside|nextrouter was not mounted/.test(e),
        insight: {
            type: "NextJSError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /getstaticprops.*should return|invalid.*getstaticprops/.test(e),
        insight: {
            type: "NextJSError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /getserversideprops.*should return|invalid.*getserversideprops/.test(e),
        insight: {
            type: "NextJSError",
    ...
    },
    {
        ...
        priority: 2,
        match: (e) => /use client.*server component|server component.*client/.test(e),
        insight: {
            type: "NextJSError",
    ...
    },
    {
        ...
        insight: {
            ...
            example: "import { fileURLToPath } from 'url'; const __dirname = path.dirname(fileURLToPath(import.meta.url));",
            confidence: "high",
        },
    },
    {
        id: "fs_browser",
        priority: 1,
        match: (e) => /cannot find module.*fs|fs.*browser|no such file or directory/.test(e),
        insight: {
            type: "EnvironmentError",
    ...
    },
    {
        id: "enomem_error",
        priority: 1,
        match: (e) => /enomem|out of memory|javascript heap|allocation failed/.test(e),
        insight: {
            type: "MemoryError",
    ...
    },
    {
        id: "esm_cjs_interop",
        priority: 1,
        match: (e) => /require.*es module|esm.*require|must use import|err_require_esm/.test(e),
        insight: {
            type: "ModuleError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /parsing error|failed to parse|unexpected token|unterminated/.test(e) &&
            !/json/.test(e),
        insight: {
            type: "SyntaxError",
    ...
    },
    {
        id: "babel_error",
        priority: 2,
        match: (e) => /babel.*error|@babel|support.*jsx|experimental syntax/.test(e),
        insight: {
            type: "BuildError",
    ...
    },
    {
        id: "typescript_error",
        priority: 1,
        match: (e) => /ts\d{4,}|typescript error|cannot find name|type.*is not assignable/.test(e),
        insight: {
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /loading chunk.*failed|chunkloaderror|chunk.*undefined/.test(e),
        insight: {
            type: "ChunkError",
    ...
    // ===============================================================
    {
        id: "stack_overflow",
        priority: 1,
        match: (e) => /maximum call stack|stack overflow|too much recursion/.test(e),
        insight: {
            type: "RangeError",
    ...
    // ===============================================================
    {
        id: "csp_violation",
        priority: 1,
        match: (e) => /content security policy|csp|refused to.*because.*violates/.test(e),
        insight: {
            type: "SecurityError",
    ...
    },
    {
        id: "iframe_blocked",
        priority: 2,
        match: (e) => /refused to display.*frame|x-frame-options|frame-ancestors/.test(e),
        insight: {
            type: "SecurityError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /cross-origin|same-origin policy|access.*blocked/.test(e) &&
            !/cors/.test(e),
        insight: {
            type: "SecurityError",
    ...
    // ===============================================================
    {
        ...
        priority: 1,
        match: (e) => /cannot read.*null.*innerhtml|null.*appendchild|getelementbyid.*null|queryselector.*null/.test(e),
        insight: {
            type: "DOMError",
            cause: "DOM element not found",
            fix: "Ensure element exists before manipulating",
            example: "const el = document.getElementById('id'); if (el) el.innerHTML = 'text';",
            confidence: "high",
        },
    },
    {
    ...
    },
    {
        id: "invalid_selector",
        priority: 1,
        match: (e) => /not a valid selector|invalid selector|syntax error.*selector/.test(e),
        insight: {
            type: "SyntaxError",
    ...
    },
    {
        ...
        insight: {
            ...
            example: "const ctx = canvas.getContext('2d') || canvas.getContext('webgl');",
            confidence: "medium",
        },
    },
    {
    ...
    },
    {
        id: "clipboard_error",
        priority: 2,
        match: (e) => /clipboard.*failed|clipboard.*denied|navigator\.clipboard/.test(e),
        insight: {
            type: "PermissionError",
    ...
    },
    {
        id: "media_error",
        priority: 2,
        match: (e) => /mediaerror|media.*failed|video.*error|audio.*error|aborted|network.*media/.test(e),
        insight: {
            type: "MediaError",
    ...
    },
    {
        ...
        priority: 2,
        match: (e) => /media.*not supported|format.*not supported|codec.*not supported/.test(e),
        insight: {
            type: "MediaError",
    ...
    },
    {
        id: "camera_error",
        priority: 2,
        match: (e) => /getusermedia|camera.*denied|microphone.*denied|permission.*denied.*media/.test(e),
        insight: {
            type: "PermissionError",
    ...
    },
    {
        id: "websocket_error",
        priority: 1,
        match: (e) => /websocket.*failed|websocket.*error|websocket.*closed/.test(e),
        insight: {
            type: "WebSocketError",
    ...
    },
    {
        id: "web_worker_error",
        priority: 2,
        match: (e) => /worker.*error|importscripts.*failed|worker.*terminated/.test(e),
        insight: {
            type: "WorkerError",
    ...
    },
    {
        id: "payment_error",
        priority: 2,
        match: (e) => /paymentrequest|payment.*failed|payment.*not supported/.test(e),
        insight: {
            type: "PaymentError",
    ...
    // ===============================================================
    {
        ...
        priority: 1,
        match: (e) => /addeventlistener.*null|removeeventlistener.*null|event.*target.*null/.test(e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        ...
        priority: 2,
        match: (e) => /passive.*preventdefault|unable to preventdefault.*passive/.test(e),
        insight: {
            type: "EventError",
    ...
    },
    {
        ...
        insight: {
            ...
            example: "element.dispatchEvent(new CustomEvent('myevent', { detail: data }))",
            confidence: "medium",
        },
    },
    // ===============================================================
    ...
    // ===============================================================
    {
        ...
        insight: {
            ...
            example: "input.setCustomValidity(''); if (!input.checkValidity()) { ... }",
            confidence: "high",
        },
    },
    {
    ...
    // ===============================================================
    {
        ...
        priority: 2,
        match: (e) => /expect.*received|tobecalled|tomatchsnapshot|matcher.*error/.test(e),
        insight: {
            type: "TestError",
    ...
    // ===============================================================
    {
        id: "prisma_error",
        priority: 2,
        match: (e) => /prisma.*error|p\d{4}|unique constraint|foreign key constraint/.test(e),
        insight: {
            type: "DatabaseError",
            cause: "Prisma database operation failed",
            fix: "Check model relations, constraints, and data",
            example: "try { await prisma.model.create(...) } catch (e) { handlePrismaError(e) }",
            confidence: "high",
        },
    },
    {
        ...
        priority: 1,
        match: (e) => /database.*connection|connect.*database|connection.*refused.*database/.test(e),
        insight: {
            type: "DatabaseError",
    ...
    },
    {
        ...
        priority: 1,
        match: (e) => /foreign key.*violation|referenced.*not exist|relation.*not found/.test(e),
        insight: {
            type: "DatabaseError",
    ...
    },
    {
        id: "jwt_invalid",
        priority: 1,
        match: (e) => /jwt.*invalid|invalid.*token|jsonwebtokenerror|malformed.*token/.test(e),
        insight: {
            type: "AuthError",
    ...
    // ===============================================================
    {
        id: "env_missing",
        priority: 1,
        match: (e) => /environment variable.*undefined|env.*not set|missing.*env/.test(e),
        insight: {
            type: "ConfigError",
    ...
    },
    {
        id: "config_invalid",
        priority: 2,
        match: (e) => /config.*invalid|invalid.*configuration|configuration.*error/.test(e),
        insight: {
            type: "ConfigError",
    ...
    },
    {
        id: "version_mismatch",
        priority: 2,
        match: (e) => /version.*mismatch|incompatible.*version|requires.*version/.test(e),
        insight: {
    ...
    // ===============================================================
    {
        id: "encoding_error",
        priority: 2,
        match: (e) => /encoding.*error|invalid.*encoding|utf-8.*error|malformed.*utf/.test(e),
        insight: {
            type: "EncodingError",
    ...
    },
    {
        id: "uri_malformed",
        priority: 2,
        match: (e) => /uri.*malformed|decodeuricomponent|encodeuricomponent/.test(e),
        insight: {
            type: "URIError",
    ...
    // ===============================================================
    {
        ...
        priority: 1,
        match: (e) => /class constructor.*cannot be invoked without.*new|must be called with new/.test(e),
        insight: {
            type: "TypeError",
    ...
    },
    {
        id: "super_not_called",
        priority: 1,
        match: (e) => /must call super|super.*not called|this.*before.*super/.test(e),
        insight: {
            type: "ReferenceError",
    ...
    },
    {
        id: "aggregateerror",
        priority: 2,
        match: (e) => /aggregateerror|multiple errors|all promises.*rejected/.test(e),
        insight: {
            type: "AggregateError",
            cause: "Multiple errors occurred (e.g., Promise.any all rejected)",
            fix: "Handle individual errors in the aggregate",
            example: "catch (e) { if (e instanceof AggregateError) e.errors.forEach(...) }",
            confidence: "high",
        },
    },
];
...
// BATCH ANALYSIS
// ===============================================================
export function analyzeMultipleErrors(errors) {
...
export const errorCategories = {
    ...
    networkErrors: errorRules
        .filter((r) => r.insight.type.includes("Network") || r.insight.type.includes("HTTP"))
        .map((r) => r.id),
    reactErrors: errorRules
        .filter((r) => r.insight.type.includes("React"))
        .map((r) => r.id),
    ssrErrors: errorRules
        .filter((r) => r.insight.type.includes("SSR") || r.insight.type.includes("Hydration"))
        .map((r) => r.id),
    buildErrors: errorRules
        .filter((r) => r.insight.type.includes("Build") || r.insight.type.includes("Module"))
        .map((r) => r.id),
    ...
    securityErrors: errorRules
        .filter((r) => r.insight.type.includes("Security") || r.insight.type.includes("CORS"))
        .map((r) => r.id),
};
// ===============================================================
// STATS
